...
namespace TestStudentExercisesAPI
{
    ...
    public class TestStudents
    {
        ...
        {
            HttpResponseMessage deleteResponse = await client.DeleteAsync($"api/students/{david.Id}");
        ...
        public async Task Test_Get_Single_Student()
        {
            ...
            using (HttpClient client = new APIClientProvider().Client)
            {
                ...
                HttpResponseMessage response = await client.GetAsync($"api/students/{newDavid.Id}");
